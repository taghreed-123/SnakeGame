...
public class GameDrawer extends JPanel implements KeyListener, ActionListener{
    ...
    ImageIcon backgroundImage =new ImageIcon(this.getClass().getResource("/images/b.jpeg"));
    ...
    ImageIcon fruitImage = new ImageIcon(this.getClass().getResource("/images/fruitt.png"));
    ...
    public void paint(Graphics g)
    {
        ...
        backgroundImage.paintIcon(this, g, 19, 19);
